...
from YouTubeComputationalSocialScience.domain.models import Video, Recommendation
...
def test_get_recommendation_temporal_analysis(recommendation_service):
    ...
    from YouTubeComputationalSocialScience.domain.models import CollectionRun, CollectionStatus
    ...
    mock_runs = [
        CollectionRun(
            ...
            source_type="video",
            source_id="video1",
            source_url="https://youtube.com/video1",
